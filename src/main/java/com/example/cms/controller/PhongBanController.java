...
public class PhongBanController {
    ...
    public CompletableFuture<ResponseData> detail(
        ...
        return CompletableFuture.completedFuture(ResponseData.createResponse(phongBanService.detail(transactionId, id)));
    }
    ...
    public CompletableFuture<ResponseData> update(
        ...
        return CompletableFuture.completedFuture(ResponseData.createResponse(phongBanService.update(transactionId, id, title)));
    }
    ...
    public CompletableFuture<ResponseData> delete(
        ...
        return CompletableFuture.completedFuture(ResponseData.createResponse(phongBanService.delete(transactionId, id)));
    }
}
