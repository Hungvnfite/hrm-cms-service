...
public class TrangThaiLamViecController {
    ...
    public CompletableFuture<ResponseData> detail(
        ...
        return CompletableFuture.completedFuture(ResponseData.createResponse(trangThaiLamViecService.detail(transactionId, id)));
    }
    ...
    public CompletableFuture<ResponseData> update(
        ...
        return CompletableFuture.completedFuture(ResponseData.createResponse(trangThaiLamViecService.update(transactionId, id, title)));
    }
    ...
    public CompletableFuture<ResponseData> delete(
        ...
        return CompletableFuture.completedFuture(ResponseData.createResponse(trangThaiLamViecService.delete(transactionId, id)));
    }
